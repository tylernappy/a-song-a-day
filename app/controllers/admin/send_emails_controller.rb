class Admin::SendEmailsController < ApplicationController
  def index
   ...
   #   debugger
   #   debugger
   #   @music_people = @search_results.select {|music_person| (music_person.first.updated_at - DateTime.current).abs > 24.hours} #only show people who haven't been sent an email
